...
using GoblinfactoryLtd.SpikeVSPackage;

namespace SpikeVSPackage_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SpikeVSPackagePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(GoblinfactoryLtd.SpikeVSPackage.GuidList.guidSpikeVSPackageCmdSet, (int)GoblinfactoryLtd.SpikeVSPackage.PkgCmdIDList.cmdGFGreeting);
