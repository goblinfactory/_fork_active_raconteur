...
namespace SpikeVSPackage_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(GoblinfactoryLtd.SpikeVSPackage.GuidList.guidSpikeVSPackageCmdSet, (int)GoblinfactoryLtd.SpikeVSPackage.PkgCmdIDList.cmdGFGreeting);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "GFSpikeVSPackage", "GoblinfactoryLtd.SpikeVSPackage.SpikeVSPackagePackage");
